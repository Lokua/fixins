...
const f = {
  ...
  /**
   * @function fx-lerp(color1, color2, [factor=0.5])
   *
   * @desc
  ...
  /**
   * @function fx-mdc(color, shade, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-orange(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-yellow(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-green(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-cyan(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-blue(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-violet(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-magenta(value, [alpha=1])
   *
   * @desc
  ...
  /**
   * @function fx-gray(value, [alpha=1])
   *
   * @desc
